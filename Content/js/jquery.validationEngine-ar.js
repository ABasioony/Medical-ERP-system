    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "future": {
                    "regex": "none",
                    "alertText": "يجب ان يكون تاريخ انتهاء العرض بعد بدايته "
                },	
                "maxCheckbox": {
                    "regex": "none",
                    "alertText": "* على الأكثر ",
			...
			"func": function (field) {
			 ...
			 "alertText": "* تاريخ غير صالح، يجب أن يكون في هيئة YYYY-MM-DD"
                ...
                "onlyLetterSp": {
                    "regex": /^[a-zA-Z\\ \']+$/,
                    "alertText": "* حروف انجليزية فقط"
                },
                "onlyLetter": {
                    "regex": /^[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z]+[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z- ]*?$/,
                    "alertText": "* حروف فقط"
                },
                "onlyArLetter": {
                    "regex": /^[\u0600-\u065F\u066A-\u06EF\u06FA-]+[\u0600-\u065F\u066A-\u06EF \u06FA\-\/]*?$/,
                    "alertText": "* حروف  عربية فقط"
                },
                "onlyLetterAccentSp": {
                    "regex": /^[a-z\u00C0-\u017F\ ]+$/i,
				...
				"ajaxFunCall": {
				    ...
				    "extraData": srvCode,
				    "extraDataDynamic": ['#ServiceCode'],
				    "alertText": "*  هذا الكود موجود مسبقا  "
				   
				},
				"ajaxFunctionCall": {
				    "url": "CkeckRoomNumExistOrNot",
				    "extraDataDynamic": ['#roomNum'],
				    "alertText": "*  هذا الرقم موجود مسبقا  ",
